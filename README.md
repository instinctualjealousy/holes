...
Diggin, diggin. Mostly holes. When I'm done, I buries them again all neat and tidy. With Scoop manifests.<br />
This is a bucket (repository) for [Scoop](https://scoop.sh), the Windows command-line installer.

How do I join Doug on his conquest t... I mean, how do I install this bucket?
---------------------------------
